...
export default function Navbar() {
  ...
  useEffect(() => {
    function handleClick(e: MouseEvent) {
      ...
      if (
        ...
        !adminPanelRef.current.contains(e.target as Node)
      ) {
        setAdminPanelOpen(false);
      }
    }
  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-5 md:px-6 max-w-7xl flex items-center justify-between">
          ...
          >
            <Image
              ...
              priority
              sizes="(max-width: 767px) 150px, (max-width: 1024px) 180px, 210px"
            />
          </Link>
                      ...
                      >
                        ...
                        >
                          {googleLoading ? (
                            ...
                            >
                              <path
                                d="M22.56 12.25c-.78 0-1.53-.07-2.25-.2H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                                fill="#4285F4"
                              />
                              <path
                                d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"
